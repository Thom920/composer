<?php
    ...
    $mailVerzonden = false;  // Variabele om te controleren of de mail is verzonden
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            // Server settings
            $mail->SMTPDebug = SMTP::DEBUG_OFF;                      // Geen debug info weergeven
            ...
            // E-mail versturen
            $mail->send();
            $mailVerzonden = true;  // Succesvolle verzending
        } catch (Exception $e) {
...
<div class="container">
    ...
    <?php if ($mailVerzonden): ?>
        <div class="message">
            De klacht is succesvol verzonden. Bedankt voor je feedback!
        </div>
    <?php endif; ?>
